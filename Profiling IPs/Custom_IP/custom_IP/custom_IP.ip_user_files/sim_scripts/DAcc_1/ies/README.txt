...
#
# Generated by export_simulation on Fri Sep 02 15:01:12 -0400 2022
#
################################################################################
...
'-reset_run' switch to the './DAcc.sh' script.
...
./DAcc.sh -noclean_files

For more information on the script, please type './DAcc.sh -help'.
