...
__attribute__((sdx_kernel("fft", 0))) void fft(double real[1024], double img[1024], double real_twid[1024/2], double img_twid[1024/2]);
...
__attribute__((sdx_kernel("fft", 0))) void fft(double real[1024], double img[1024], double real_twid[1024/2], double img_twid[1024/2]){_ssdm_SpecArrayDimSize(real, 1024);_ssdm_SpecArrayDimSize(img, 1024);_ssdm_SpecArrayDimSize(real_twid, 512);_ssdm_SpecArrayDimSize(img_twid, 512);
#pragma HLS TOP name=fft
# 3 "../CCode_fft/fft.c"
