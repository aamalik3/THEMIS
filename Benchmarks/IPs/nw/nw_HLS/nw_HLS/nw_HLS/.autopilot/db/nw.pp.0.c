...
__attribute__((sdx_kernel("needwun", 0))) void needwun(char SEQA[128], char SEQB[128],
             char alignedA[128 +128], char alignedB[128 +128],
             int M[(128 +1)*(128 +1)], char ptr[(128 +1)*(128 +1)]);
...
__attribute__((sdx_kernel("needwun", 0))) void needwun(char SEQA[128], char SEQB[128],
             char alignedA[128 +128], char alignedB[128 +128],
             int M[(128 +1)*(128 +1)], char ptr[(128 +1)*(128 +1)]){_ssdm_SpecArrayDimSize(SEQA, 128);_ssdm_SpecArrayDimSize(SEQB, 128);_ssdm_SpecArrayDimSize(alignedA, 256);_ssdm_SpecArrayDimSize(alignedB, 256);_ssdm_SpecArrayDimSize(M, 16641);_ssdm_SpecArrayDimSize(ptr, 16641);
#pragma HLS TOP name=needwun
# 15 "../CCode/nw.c"


#pragma HLS INTERFACE s_axilite port=SEQA bundle=BUS_A
#pragma HLS INTERFACE s_axilite port=SEQB bundle=BUS_A
#pragma HLS INTERFACE s_axilite port=alignedA bundle=BUS_A
#pragma HLS INTERFACE s_axilite port=alignedB bundle=BUS_A
#pragma HLS INTERFACE s_axilite port=M bundle=BUS_A
#pragma HLS INTERFACE s_axilite port=ptr bundle=BUS_A
#pragma HLS INTERFACE s_axilite port=return bundle=BUS_A
 ...
 int score, up_left, up, left, max;
    ...
    init_row: for(a_idx=0; a_idx<(128 +1); a_idx++){
        M[a_idx] = a_idx * -1;
    }
    init_col: for(b_idx=0; b_idx<(128 +1); b_idx++){
