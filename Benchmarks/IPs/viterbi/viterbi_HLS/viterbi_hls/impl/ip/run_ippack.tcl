...
set IPName      "viterbi"
set Version     "1.0"
set DisplayName "Viterbi"
set Revision    "2209011217"
...
set xo_kernel_name "viterbi"
set xo_kernel_files {}
set enable_xo_gen false
set kernel_xml [file join [pwd] ../kernel/kernel.xml]
set solution_dir "C:/Users/aamalik3/Desktop/IPs/viterbi/viterbi_HLS/viterbi_hls"
set debug_dir "C:/Users/aamalik3/Desktop/IPs/viterbi/viterbi_HLS/viterbi_hls/.debug"
set xo_hls_files_dir ""
set hdl_module_list {viterbi_dadd_64ns_64ns_64_5_full_dsp_1
...
set Interfaces {
    s_axi_BUS_A {
        ...
        memories "obs {base_address 256 range 256} init {base_address 512 range 512} path {base_address 1024 range 256} transition {base_address 32768 range 32768} emission {base_address 65536 range 32768}"
        ctype {
            AWVALID {
                Type "bool"
                Width "1"
...
## System Info
set user_parameters_list {clk_period 10 machine 64 combinational 0 latency 1219794 II x}
