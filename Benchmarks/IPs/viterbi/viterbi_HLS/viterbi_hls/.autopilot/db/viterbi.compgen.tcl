...
set id 1
set name viterbi_dadd_64ns_64ns_64_5_full_dsp_1
...
if {${::AESL::PGuard_simmodel_gen}} {
	if {[info proc ::AESL_LIB_XILADAPTER::s_axilite_gen] == "::AESL_LIB_XILADAPTER::s_axilite_gen"} {
		eval "::AESL_LIB_XILADAPTER::s_axilite_gen { \
			id 7 \
			corename viterbi_BUS_A_axilite \
			name viterbi_BUS_A_s_axi \
			ports {$port_BUS_A} \
			op interface \
			is_flushable 0 \ 
			is_datawidth64 0 \ 
...
if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler viterbi_BUS_A_s_axi
}
