...
HD_PWD='C:/Users/ekarabu/Desktop/Aydin_amro/github_files/Scheduling-PR/IPs/template/template.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log custom_IP.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source custom_IP.tcl
