...
# 2 "<built-in>" 2
# 1 "../CCode_stencil2d/stencil.c" 2
# 1 "../CCode_stencil2d/stencil.h" 1
...
# 3 "../CCode_stencil2d/stencil.h" 2
# 1 "../CCode_stencil2d/support.h" 1
...
# 4 "../CCode_stencil2d/stencil.h" 2
# 18 "../CCode_stencil2d/stencil.h"
__attribute__((sdx_kernel("stencil", 0))) void stencil( int32_t orig[128 * 64],
        int32_t sol[128 * 64],
        int32_t filter[9] );
...
# 2 "../CCode_stencil2d/stencil.c" 2

__attribute__((sdx_kernel("stencil", 0))) void stencil (int32_t orig[128 * 64], int32_t sol[128 * 64], int32_t filter[9]){_ssdm_SpecArrayDimSize(orig, 8192);_ssdm_SpecArrayDimSize(sol, 8192);_ssdm_SpecArrayDimSize(filter, 9);
#pragma HLS TOP name=stencil
# 3 "../CCode_stencil2d/stencil.c"


#pragma HLS INTERFACE s_axilite port=orig bundle=BUS_A
#pragma HLS INTERFACE s_axilite port=sol bundle=BUS_A
#pragma HLS INTERFACE s_axilite port=filter bundle=BUS_A
#pragma HLS INTERFACE s_axilite port=return bundle=BUS_A

 int r, c, k1, k2;
    int32_t temp, mul;

    stencil_label1:for (r=0; r<128 -2; r++) {
        stencil_label2:for (c=0; c<64 -2; c++) {
            temp = (int32_t)0;
