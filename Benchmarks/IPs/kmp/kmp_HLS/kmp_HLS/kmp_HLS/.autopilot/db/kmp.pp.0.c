...
__attribute__((sdx_kernel("kmp", 0))) int kmp(char pattern[4], char input[(32411)], int32_t kmpNext[4], int32_t n_matches[1]);
...
void CPF(char pattern[4], int32_t kmpNext[4]) {
    int32_t k, q;
    k = 0;
    kmpNext[0] = 0;
...
__attribute__((sdx_kernel("kmp", 0))) int kmp(char pattern[4], char input[(32411)], int32_t kmpNext[4], int32_t n_matches[1]) {_ssdm_SpecArrayDimSize(pattern, 4);_ssdm_SpecArrayDimSize(input, 32411);_ssdm_SpecArrayDimSize(kmpNext, 4);_ssdm_SpecArrayDimSize(n_matches, 1);
#pragma HLS TOP name=kmp
# 24 "../CCode_kmp/kmp.c"


#pragma HLS INTERFACE s_axilite port=pattern bundle=BUS_A
#pragma HLS INTERFACE s_axilite port=input bundle=BUS_A
#pragma HLS INTERFACE s_axilite port=kmpNext bundle=BUS_A
#pragma HLS INTERFACE s_axilite port=n_matches bundle=BUS_A
