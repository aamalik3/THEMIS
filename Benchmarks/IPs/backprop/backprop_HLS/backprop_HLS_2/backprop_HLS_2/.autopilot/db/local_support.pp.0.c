# 1 "../CCode_backprop/local_support.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 359 "<built-in>" 3
# 1 "<command line>" 1
...
# 2 "<built-in>" 2
# 1 "../CCode_backprop/local_support.c" 2
...
# 2 "../CCode_backprop/local_support.c" 2
...
# 3 "../CCode_backprop/local_support.c" 2
...
# 22 "../CCode_backprop/local_support.c"
void input_to_data(int fd, void *vdata) {
