...
# 10 "../CCODE_Blocked/gemm.h" 2
# 1 "../CCODE_Blocked/support.h" 1
...
# 11 "../CCODE_Blocked/gemm.h" 2
# 29 "../CCODE_Blocked/gemm.h"
...
# 9 "../CCODE_Blocked/gemm.c" 2

__attribute__((sdx_kernel("bbgemm", 0))) void bbgemm(double m1[64*64], double m2[64*64], double prod[64*64]){_ssdm_SpecArrayDimSize(m1, 4096);_ssdm_SpecArrayDimSize(m2, 4096);_ssdm_SpecArrayDimSize(prod, 4096);
#pragma HLS TOP name=bbgemm
# 10 "../CCODE_Blocked/gemm.c"


#pragma HLS INTERFACE s_axilite port=m1 bundle=BUS_A
#pragma HLS INTERFACE s_axilite port=m2 bundle=BUS_A
#pragma HLS INTERFACE s_axilite port=prod bundle=BUS_A
