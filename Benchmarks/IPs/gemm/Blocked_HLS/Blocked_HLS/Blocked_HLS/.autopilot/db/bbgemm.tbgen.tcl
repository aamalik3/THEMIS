...
set C_modelName {bbgemm}
set C_modelType { void 0 }
set C_modelArgList {
	{ m1 int 64 regular {axi_slave 0}  }
	{ m2 int 64 regular {axi_slave 0}  }
	{ prod int 64 regular {axi_slave 2}  }
}
set C_modelArgMapList {[ 
	{ "Name" : "m1", "interface" : "axi_slave", "bundle":"BUS_A","type":"ap_memory","bitwidth" : 64, "direction" : "READONLY", "bitSlice":[{"low":0,"up":0,"cElement": [{"cName": "m1","cData": "long","bit_use": { "low": 0,"up": 0},"cArray": [{"low" : 0,"up" : 0,"step" : 0}]}]}], "offset" : {"in":32768}, "offset_end" : {"in":65535}} , 
 	{ "Name" : "m2", "interface" : "axi_slave", "bundle":"BUS_A","type":"ap_memory","bitwidth" : 64, "direction" : "READONLY", "bitSlice":[{"low":0,"up":0,"cElement": [{"cName": "m2","cData": "long","bit_use": { "low": 0,"up": 0},"cArray": [{"low" : 0,"up" : 0,"step" : 0}]}]}], "offset" : {"in":65536}, "offset_end" : {"in":98303}} , 
 	{ "Name" : "prod", "interface" : "axi_slave", "bundle":"BUS_A","type":"ap_memory","bitwidth" : 64, "direction" : "READWRITE", "bitSlice":[{"low":0,"up":0,"cElement": [{"cName": "prod","cData": "long","bit_use": { "low": 0,"up": 0},"cArray": [{"low" : 0,"up" : 0,"step" : 0}]}]}], "offset" : {"in":98304, "out":98304}, "offset_end" : {"in":131071, "out":131071}} ]}
...
set NewPortList {[ 
	{ "name": "s_axi_BUS_A_AWADDR", "direction": "in", "datatype": "sc_lv", "bitwidth":17, "type": "signal", "bundle":{"name": "BUS_A", "role": "AWADDR" },"address":[{"name":"bbgemm","role":"start","value":"0","valid_bit":"0"},{"name":"bbgemm","role":"continue","value":"0","valid_bit":"4"},{"name":"bbgemm","role":"auto_start","value":"0","valid_bit":"7"},{"name":"m1","role":"data","value":"32768"},{"name":"m2","role":"data","value":"65536"},{"name":"prod","role":"data","value":"98304"}] },
	...
	{ "name": "s_axi_BUS_A_ARADDR", "direction": "in", "datatype": "sc_lv", "bitwidth":17, "type": "signal", "bundle":{"name": "BUS_A", "role": "ARADDR" },"address":[{"name":"bbgemm","role":"start","value":"0","valid_bit":"0"},{"name":"bbgemm","role":"done","value":"0","valid_bit":"1"},{"name":"bbgemm","role":"idle","value":"0","valid_bit":"2"},{"name":"bbgemm","role":"ready","value":"0","valid_bit":"3"},{"name":"bbgemm","role":"auto_start","value":"0","valid_bit":"7"},{"name":"prod","role":"data","value":"98304"}] },
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1", "2", "3"],
		...
		"II" : "0",
		"VariableLatency" : "1", "ExactLatency" : "-1", "EstimateLatencyMin" : "557065", "EstimateLatencyMax" : "557065",
		"Combinational" : "0",
		"Datapath" : "0",
		"ClockEnable" : "0",
		"HasSubDataflow" : "0",
...
set ArgLastReadFirstWriteLatency {
	bbgemm {
		m1 {Type I LastRead 2 FirstWrite -1}
		m2 {Type I LastRead 9 FirstWrite -1}
		prod {Type IO LastRead 13 FirstWrite 15}}}

set hasDtUnsupportedChannel 0

set PerformanceInfo {[
	{"Name" : "Latency", "Min" : "557065", "Max" : "557065"}
	, {"Name" : "Interval", "Min" : "557066", "Max" : "557066"}
]}
