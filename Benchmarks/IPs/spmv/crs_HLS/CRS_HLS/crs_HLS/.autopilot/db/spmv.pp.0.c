...
# 2 "<built-in>" 2
# 1 "../CCode_crs/spmv.c" 2





# 1 "../CCode_crs/spmv.h" 1
...
# 8 "../CCode_crs/spmv.h" 2
# 1 "../CCode_crs/support.h" 1
...
__attribute__((sdx_kernel("spmv", 0))) void spmv(double val[1666], int32_t cols[1666], int32_t rowDelimiters[494 + 1],
...
# 7 "../CCode_crs/spmv.c" 2

__attribute__((sdx_kernel("spmv", 0))) void spmv(double val[1666], int32_t cols[1666], int32_t rowDelimiters[494 +1], double vec[494], double out[494]){_ssdm_SpecArrayDimSize(val, 1666);_ssdm_SpecArrayDimSize(cols, 1666);_ssdm_SpecArrayDimSize(rowDelimiters, 495);_ssdm_SpecArrayDimSize(vec, 494);_ssdm_SpecArrayDimSize(out, 494);
