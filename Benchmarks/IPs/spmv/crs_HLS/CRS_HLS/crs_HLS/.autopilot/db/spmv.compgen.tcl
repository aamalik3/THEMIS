...
set id 1
set name spmv_dadd_64ns_64ns_64_5_full_dsp_1
...
set id 2
set name spmv_dmul_64ns_64ns_64_6_max_dsp_1
...
if {${::AESL::PGuard_simmodel_gen}} {
	if {[info proc ::AESL_LIB_XILADAPTER::s_axilite_gen] == "::AESL_LIB_XILADAPTER::s_axilite_gen"} {
		eval "::AESL_LIB_XILADAPTER::s_axilite_gen { \
			id 5 \
			corename spmv_BUS_A_axilite \
			name spmv_BUS_A_s_axi \
			ports {$port_BUS_A} \
			op interface \
			is_flushable 0 \ 
			is_datawidth64 0 \ 
...
if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler spmv_BUS_A_s_axi
}
