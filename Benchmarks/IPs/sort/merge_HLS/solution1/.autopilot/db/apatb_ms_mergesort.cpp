...
extern "C" void ms_mergesort_hw_stub_wrapper(volatile void *);

extern "C" void apatb_ms_mergesort_hw(volatile void * __xlx_apatb_param_a) {
...
ms_mergesort_hw_stub_wrapper(__xlx_apatb_param_a);
