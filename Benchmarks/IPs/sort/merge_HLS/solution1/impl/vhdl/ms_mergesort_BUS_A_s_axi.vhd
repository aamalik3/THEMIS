...
entity ms_mergesort_BUS_A_s_axi is
generic (
...
end entity ms_mergesort_BUS_A_s_axi;
...
architecture behave of ms_mergesort_BUS_A_s_axi is
    ...
    component ms_mergesort_BUS_A_s_axi_ram is
        generic (
            BYTES   : INTEGER :=4;
            DEPTH   : INTEGER :=256;
            AWIDTH  : INTEGER :=8);
    ...
    end component ms_mergesort_BUS_A_s_axi_ram;
...
-- ----------------------- Instantiation------------------
-- int_a
int_a : ms_mergesort_BUS_A_s_axi_ram
generic map (
     BYTES    => 4,
     DEPTH    => 2048,
     AWIDTH   => log2(2048))
...
-- ----------------------- Memory logic ------------------
    ...
    int_a_ce0            <= a_ce0;
    int_a_we0            <= a_we0;
    int_a_be0            <= (others => a_we0);
    int_a_d0             <= RESIZE(UNSIGNED(a_d0), 32);
...
entity ms_mergesort_BUS_A_s_axi_ram is
    generic (
        BYTES   : INTEGER :=4;
        DEPTH   : INTEGER :=256;
        AWIDTH  : INTEGER :=8);
...
end entity ms_mergesort_BUS_A_s_axi_ram;

architecture behave of ms_mergesort_BUS_A_s_axi_ram is
