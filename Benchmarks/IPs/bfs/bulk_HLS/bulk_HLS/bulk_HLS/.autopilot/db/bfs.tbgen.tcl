...
set C_modelArgList {
	{ nodes int 128 regular {axi_slave 0}  }
	{ edges int 64 regular {axi_slave 0}  }
	{ starting_node int 64 regular {axi_slave 0}  }
	{ level int 8 regular {axi_slave 2}  }
	{ level_counts int 64 regular {axi_slave 1}  }
}
set C_modelArgMapList {[ 
	{ "Name" : "nodes", "interface" : "axi_slave", "bundle":"BUS_A","type":"ap_memory","bitwidth" : 128, "direction" : "READONLY", "bitSlice":[{"low":0,"up":0,"cElement": [{"cName": "nodes","cData": "int128","bit_use": { "low": 0,"up": 0},"cArray": [{"low" : 0,"up" : 0,"step" : 0}]}]}], "offset" : {"in":4096}, "offset_end" : {"in":8191}} , 
 	{ "Name" : "edges", "interface" : "axi_slave", "bundle":"BUS_A","type":"ap_memory","bitwidth" : 64, "direction" : "READONLY", "bitSlice":[{"low":0,"up":0,"cElement": [{"cName": "edges","cData": "long","bit_use": { "low": 0,"up": 0},"cArray": [{"low" : 0,"up" : 0,"step" : 0}]}]}], "offset" : {"in":32768}, "offset_end" : {"in":65535}} , 
 	{ "Name" : "starting_node", "interface" : "axi_slave", "bundle":"BUS_A","type":"ap_none","bitwidth" : 64, "direction" : "READONLY", "bitSlice":[{"low":0,"up":0,"cElement": [{"cName": "starting_node","cData": "long","bit_use": { "low": 0,"up": 0},"cArray": [{"low" : 0,"up" : 0,"step" : 0}]}]}], "offset" : {"in":16}, "offset_end" : {"in":27}} , 
 	{ "Name" : "level", "interface" : "axi_slave", "bundle":"BUS_A","type":"ap_memory","bitwidth" : 8, "direction" : "READWRITE", "bitSlice":[{"low":0,"up":0,"cElement": [{"cName": "level","cData": "char","bit_use": { "low": 0,"up": 0},"cArray": [{"low" : 0,"up" : 0,"step" : 0}]}]}], "offset" : {"in":256, "out":256}, "offset_end" : {"in":511, "out":511}} , 
 	{ "Name" : "level_counts", "interface" : "axi_slave", "bundle":"BUS_A","type":"ap_memory","bitwidth" : 64, "direction" : "WRITEONLY", "bitSlice":[{"low":0,"up":0,"cElement": [{"cName": "level_counts","cData": "long","bit_use": { "low": 0,"up": 0},"cArray": [{"low" : 0,"up" : 0,"step" : 0}]}]}], "offset" : {"out":128}, "offset_end" : {"out":255}} ]}
...
set NewPortList {[ 
	{ "name": "s_axi_BUS_A_AWADDR", "direction": "in", "datatype": "sc_lv", "bitwidth":16, "type": "signal", "bundle":{"name": "BUS_A", "role": "AWADDR" },"address":[{"name":"bfs","role":"start","value":"0","valid_bit":"0"},{"name":"bfs","role":"continue","value":"0","valid_bit":"4"},{"name":"bfs","role":"auto_start","value":"0","valid_bit":"7"},{"name":"starting_node","role":"data","value":"16"},{"name":"level","role":"data","value":"256"},{"name":"nodes","role":"data","value":"4096"},{"name":"edges","role":"data","value":"32768"}] },
	...
	{ "name": "s_axi_BUS_A_ARADDR", "direction": "in", "datatype": "sc_lv", "bitwidth":16, "type": "signal", "bundle":{"name": "BUS_A", "role": "ARADDR" },"address":[{"name":"bfs","role":"start","value":"0","valid_bit":"0"},{"name":"bfs","role":"done","value":"0","valid_bit":"1"},{"name":"bfs","role":"idle","value":"0","valid_bit":"2"},{"name":"bfs","role":"ready","value":"0","valid_bit":"3"},{"name":"bfs","role":"auto_start","value":"0","valid_bit":"7"},{"name":"level_counts","role":"data","value":"128"},{"name":"level","role":"data","value":"256"}] },
