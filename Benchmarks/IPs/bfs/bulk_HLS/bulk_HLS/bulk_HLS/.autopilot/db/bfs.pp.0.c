...
# 11 "../CCOde_bulk/bfs.h" 2
# 1 "../CCOde_bulk/support.h" 1
...
__attribute__((sdx_kernel("bfs", 0))) void bfs(node_t nodes[(1LL<<8)], edge_t edges[((1LL<<8)*16)],
            ...
            edge_index_t level_counts[10])
{_ssdm_SpecArrayDimSize(nodes, 256);_ssdm_SpecArrayDimSize(edges, 4096);_ssdm_SpecArrayDimSize(level, 256);_ssdm_SpecArrayDimSize(level_counts, 10);
#pragma HLS TOP name=bfs
# 12 "../CCOde_bulk/bfs.c"

#pragma HLS INTERFACE s_axilite port=nodes bundle=BUS_A
#pragma HLS INTERFACE s_axilite port=edges bundle=BUS_A
#pragma HLS INTERFACE s_axilite port=starting_node bundle=BUS_A
#pragma HLS INTERFACE s_axilite port=level bundle=BUS_A
#pragma HLS INTERFACE s_axilite port=level_counts bundle=BUS_A
