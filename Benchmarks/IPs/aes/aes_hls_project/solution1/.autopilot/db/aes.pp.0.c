...
__attribute__((sdx_kernel("aes256_encrypt_ecb", 0))) void aes256_encrypt_ecb(aes256_context *ctx, uint8_t k[32], uint8_t buf[16]);
...
__attribute__((sdx_kernel("aes256_encrypt_ecb", 0))) void aes256_encrypt_ecb(aes256_context *ctx, uint8_t k[32], uint8_t buf[16])
{_ssdm_SpecArrayDimSize(k, 32);_ssdm_SpecArrayDimSize(buf, 16);
#pragma HLS TOP name=aes256_encrypt_ecb
# 177 "aes/aes.c"

#pragma HLS INTERFACE s_axilite port=k bundle=BUS_A
#pragma HLS INTERFACE s_axilite port=ctx bundle=BUS_A
