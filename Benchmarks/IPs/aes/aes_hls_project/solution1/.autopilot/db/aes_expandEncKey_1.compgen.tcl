...
set ID 1
set hasByteEnable 0
set MemName aes256_encrypt_ecb_aes_expandEncKey_1_sbox
...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    corename ctx \
    op interface \
    ports { ctx_address0 { O 7 vector } ctx_ce0 { O 1 bit } ctx_we0 { O 1 bit } ctx_d0 { O 8 vector } ctx_q0 { I 8 vector } } \
} "
} else {
puts "@W \[IMPL-110\] Cannot find bus interface model in the library. Ignored generation of bus interface for 'ctx'"
}
}
